...
cl /nologo /O2 /W4 /Zi /fsanitize=address /MD /I"../../include" /I"%SQLITE_INC%" /std:c++14 /Fe:bin\test_value.exe test_value.cpp "%SQLITE_LIB%"
if %ERRORLEVEL% neq 0 exit /b %ERRORLEVEL%

cl /nologo /O2 /W4 /Zi /fsanitize=address /MD /I"../../include" /I"%SQLITE_INC%" /std:c++14 /Fe:bin\test_value_std.exe test_value_std.cpp "%SQLITE_LIB%"
if %ERRORLEVEL% neq 0 exit /b %ERRORLEVEL%

bin\test_value.exe
if %ERRORLEVEL% neq 0 exit /b %ERRORLEVEL%

bin\test_value_std.exe
if %ERRORLEVEL% neq 0 exit /b %ERRORLEVEL%
