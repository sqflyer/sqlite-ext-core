...
cl /nologo /O2 /W4 /Zi /fsanitize=address /MD /I"../../include" /I"%SQLITE_INC%" /std:c++17 /c /Fo:bin\test_tu_a.obj test_tu_a.cpp
if %ERRORLEVEL% neq 0 exit /b %ERRORLEVEL%

cl /nologo /O2 /W4 /Zi /fsanitize=address /MD /I"../../include" /I"%SQLITE_INC%" /std:c++17 /c /Fo:bin\test_tu_b.obj test_tu_b.cpp
if %ERRORLEVEL% neq 0 exit /b %ERRORLEVEL%

cl /nologo /O2 /W4 /Zi /fsanitize=address /MD /I"../../include" /I"%SQLITE_INC%" /std:c++17 /c /Fo:bin\test_tu_main.obj test_tu_main.cpp
if %ERRORLEVEL% neq 0 exit /b %ERRORLEVEL%
