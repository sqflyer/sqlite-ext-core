...
cl /nologo /O2 /W4 /I"../../include" /I"%SQLITE_INC%" /std:c++14 /GR- /EHs-c- /DSQLITE_THREADSAFE=1 /Fe:bin\test_transaction.exe test_transaction.cpp "%SQLITE_LIB%" /link /NODEFAULTLIB:msvcprt.lib /NODEFAULTLIB:libcpmt.lib
if %ERRORLEVEL% neq 0 exit /b %ERRORLEVEL%

bin\test_transaction.exe
if %ERRORLEVEL% neq 0 exit /b %ERRORLEVEL%
