...
cl /nologo /O2 /W4 /Zi /fsanitize=address /MD /I"../../include" /I"%SQLITE_INC%" /std:c++17 /DSQLITE_THREADSAFE=1 /Fe:bin\test_transaction.exe test_transaction.cpp "%SQLITE_LIB%"
