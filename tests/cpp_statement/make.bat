...
cl /nologo /O2 /W4 /I"../../include" /I"%SQLITE_INC%" /std:c++14 /GR- /EHs-c- /Fe:bin\test_statement.exe test_statement.cpp "%SQLITE_LIB%" /link /NODEFAULTLIB:msvcprt.lib /NODEFAULTLIB:libcpmt.lib
if %ERRORLEVEL% neq 0 exit /b %ERRORLEVEL%

bin\test_statement.exe
if %ERRORLEVEL% neq 0 exit /b %ERRORLEVEL%
