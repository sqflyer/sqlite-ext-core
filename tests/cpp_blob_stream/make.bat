...
cl /nologo /O2 /W4 /Zi /fsanitize=address /MD /I"../../include" /I"%SQLITE_INC%" /std:c++14 /DSQLITE_THREADSAFE=1 /Fe:bin\test_blob_stream.exe test_blob_stream.cpp "%SQLITE_LIB%"
