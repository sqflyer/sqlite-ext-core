...
cl /nologo /O2 /W4 /I"../include" /I"%SQLITE_INC%" /std:c++14 /GR- /EHs-c- /LD /Fe:build\libexample.dll example.cpp /link /NODEFAULTLIB:msvcprt.lib /NODEFAULTLIB:libcpmt.lib
