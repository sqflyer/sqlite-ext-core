...
- **Generic 8x8 Compile-Time Matrix Dispatch & Triangular Pruning**: `SQLITE_DISPATCH_1D_8`, `SQLITE_DISPATCH_2D_8X8`, `SQLITE_DISPATCH_ROW_KEY_COLS_8X8` (lower-triangular bound pruning $KeyN \le ColsN$ eliminating 28 impossible pairs for a 44% code reduction), `SQLITE_DISPATCH_VALID_2D`, `SQLITE_WITH_ROW_OWNED_1D`, and `SQLITE_WITH_KEY_VAL_OWNED_8X8` expand runtime column/key configurations into compile-time `constexpr` specializations for any storage template or stack span in 1 line.
