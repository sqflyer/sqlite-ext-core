...
- **Array Accessors & Hashing (`SQLITE_DERIVE_ARRAY_ACCESSORS`, `SQLITE_DERIVE_ARRAY_HASH`)**: Inlined typed extractions and 64-bit xxHash3 composite hashing with $O(1)$ scalar fast-paths and sequential mixer folding.
