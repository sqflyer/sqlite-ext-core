.PHONY: test test-ext-state test-cpp-value-keys test-locks test-allocator leak-check-integration clean

test: test-ext-state test-cpp-value-keys test-locks test-allocator
